...
st.info("🔎 급성기관지염의 경우, 코로나19 유행으로 인해 마스크 착용과 사회적 거리두기 같은 특수한 상황이 값에 영향을 미쳤을 것으로 추측됨.")
...
with col1:
    ...
    st.pyplot(fig)
    unsafe_allow_html=True
st.info("🔎 노인 치과 질환 수요가 가장 높음에도 불구하고, 일반병원 대비 치과병원 인프라가 2.5배나 부족한 현상을 그래프를 통해 확인 가능")
